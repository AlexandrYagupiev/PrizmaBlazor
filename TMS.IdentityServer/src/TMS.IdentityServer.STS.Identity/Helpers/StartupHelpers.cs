...
using TMS.IdentityServer.STS.Identity.Configuration;
using TMS.IdentityServer.STS.Identity.Configuration.ApplicationParts;
using TMS.IdentityServer.STS.Identity.Configuration.Constants;
using TMS.IdentityServer.STS.Identity.Configuration.Interfaces;
using TMS.IdentityServer.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace TMS.IdentityServer.STS.Identity.Helpers
{
