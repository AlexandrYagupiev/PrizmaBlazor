...
using TMS.IdentityServer.Admin.Api.Configuration;
using TMS.IdentityServer.Admin.Api.Configuration.Authorization;
using TMS.IdentityServer.Admin.Api.ExceptionHandling;
using TMS.IdentityServer.Admin.Api.Helpers;
using TMS.IdentityServer.Admin.Api.Mappers;
using TMS.IdentityServer.Admin.Api.Resources;
using TMS.IdentityServer.Admin.EntityFramework.Shared.DbContexts;
using TMS.IdentityServer.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;
using TMS.IdentityServer.Shared.Dtos;
using TMS.IdentityServer.Shared.Dtos.Identity;

namespace TMS.IdentityServer.Admin.Api
{
